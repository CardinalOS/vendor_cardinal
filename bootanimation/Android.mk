...
$(TARGET_GENERATED_BOOTANIMATION): $(SOONG_ZIP)
	...
	$(hide) tar xfp vendor/cardinal/bootanimation/bootanimation.tar -C $(INTERMEDIATES)
	...
	prebuilts/tools-cardinal/${HOST_OS}-x86/bin/mogrify -resize $$RESOLUTION -colors 250 $(INTERMEDIATES)/*/*.png; \
	echo "$$IMAGESCALEWIDTH $$IMAGESCALEHEIGHT 60" > $(INTERMEDIATES)/desc.txt; \
	cat vendor/cardinal/bootanimation/desc.txt >> $(INTERMEDIATES)/desc.txt
