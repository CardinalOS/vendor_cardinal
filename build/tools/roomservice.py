...
custom_local_manifest = ".repo/local_manifests/manifest.xml"
custom_default_revision = "U"
custom_dependencies = "cardinal.dependencies"
org_manifest = "CardinalOS-Devices"  # leave empty if org is provided in manifest
org_display = "CardinalOS-Devices"  # needed for displaying

default_manifest = ".repo/manifests/default.xml"
cardinal_manifest = ".repo/manifests/snippets/cardinal.xml"
others_manifest = ".repo/manifests/snippets/others.xml"
...
def add_to_manifest(repos, fallback_branch=None):
    ...
    cardinalm = load_manifest(cardinal_manifest)
    othersm = load_manifest(others_manifest)
    ...
    for repo in repos:
        ...
        if exists_in_tree(cardinalm, repo_path) != None:
           existing_m_project = exists_in_tree(cardinalm, repo_path)
        elif exists_in_tree(othersm, repo_path) != None:
             existing_m_project = exists_in_tree(othersm, repo_path)
